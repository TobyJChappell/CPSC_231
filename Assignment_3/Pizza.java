...
public class Pizza{
	...
	*/
	...
	/**
	Tests the code by creating a default Pizza and overloaded Pizza, getting variables,
	setting variables, and displaying a String using the getDescription() method
	*/
	public static void main(String[] args){
		Pizza p1 = new Pizza();
		System.out.println("\nDefault -  " + p1.getDescription());
		p1.setSize("Large");
		p1.setCheese(3);
		p1.setPepperoni(5);
		p1.setHam(1);
		System.out.println("Modified Default -  " + p1.getDescription());
		Pizza p2 = new Pizza("Medium", 2, 1, 5);
		System.out.println("\nOverloaded -  " + p2.getDescription());
		System.out.println("Size: " + p2.getSize());
		System.out.println("Cheese: " + p2.getCheese());
		System.out.println("Pepperoni: " + p2.getPepperoni());
